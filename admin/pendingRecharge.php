...
<div class="row">
    <div class="col-lg-12">
        <div class="page-title">
            <ol class="breadcrumb">
                <li><i class="fa fa-dashboard"></i> <a href="index">Reacharge Pending</a>
                </li>
                ...
                <div class="table-responsive" style="text-align: center;">
                    <table id="withdra-table" class="table table-striped table-bordered table-hover table-green">
                        ...
                        <tbody>
                            ...
                            <?php
                            $que = "SELECT * FROM bz_recharge_history WHERE $dateFilter AND bz_status = 0 ORDER BY bz_recharge_id DESC ";
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $row['bz_time'] ?></td>
                                        <td>
                                            <a href="recharge_success.php?id=<?=$row['bz_transection_id']?>" class="btn btn-success">Approved</a>
                                            <a href="recharge_failed.php?id=<?=$row['bz_transection_id']?>" class="btn btn-danger">Rejected</a>
