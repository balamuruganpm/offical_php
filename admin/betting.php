...
<div class="row">
    <div class="col-lg-12">
        <div class="page-title">
            <ol class="breadcrumb">
                <li><i class="fa fa-dashboard"></i> <a href="index">Betting Management</a>
                </li>
                ...
                <div class="table-responsive" style="text-align: center;">
                    <table id="payment-table" class="table table-striped table-bordered table-hover table-green payment_table">
                        ...
                        <tbody>
                            ...
                            <?php
                            $que = "SELECT a.*,b.bz_cus_name FROM `bz_participent` AS a JOIN `bz_customer` AS b ON a.`bz_cus_id` = b.`bz_cus_id` WHERE $dateFilter";
                            ...
                            ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $row['bz_game_type'] ?></td>
                                        <td><?= $row['join_color'] ?></td>
                                        <td><?=$row['bz_bet']?></td>
                                        <td><?= $row['bz_spend_amount'] ?></td>
                                        <td><?= $row['bz_win_amount'] ?></td>
                                        <td><?= date('d-m-Y H:i', strtotime($row['bz_spend_date'])); ?></td>
