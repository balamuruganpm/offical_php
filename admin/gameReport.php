...
<div class="row">
    <div class="col-lg-12">
        <div class="page-title">
            <ol class="breadcrumb">
                <li><i class="fa fa-dashboard"></i> <a href="index">Game Report</a>
                </li>
        ...
        <tbody>
            <tr>
                ...
                <form action="refresh.php" method="post">
                    <td>
                        &nbsp;
                        <button class="btn btn-info" name="refresh_game_rep" id="refreshbtn"><i class="fa fa-refresh"></i></button>
                    </td>
                </form>
            </tr>
        </tbody>
...
// API Request
$api_url = "https://teckzy.in/colorcash/RestApi/UserApi/bet_list.php";
$api_key = "CC@2024";
