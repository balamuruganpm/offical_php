...
<div class="row">
    <div class="col-lg-12">
        <div class="page-title">
            <ol class="breadcrumb">
                <li><i class="fa fa-dashboard"></i> <a href="index">Reacharge Failed</a>
                </li>
                ...
                <div class="table-responsive" style="text-align: center;">
                    <table id="withdra-table" class="table table-striped table-bordered table-hover table-green">
                        ...
                        <tbody>
                            ...
                            <?php
                            $que = "SELECT * FROM bz_recharge_history WHERE $dateFilter AND bz_status = 2 ORDER BY bz_recharge_id DESC ";
